// kids-memory.js - UPDATED with modal popup for email
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createGameContainer() {
        ...
        gameSection.innerHTML = `
            <div class="game-container" style="background: linear-gradient(135deg, #FCE7F3, #FBCFE8); border-radius: 30px; padding: 1.5rem; margin: 2rem 0; border: 4px solid var(--gold); text-align: center;">
                ...
                <button id="play-memory-btn" class="btn btn-primary" style="padding: 1rem 3rem; font-size: 1.2rem;">🎮 Play Game</button>
        ...
        document.getElementById('play-memory-btn').addEventListener('click', () => {
            showEmailModal(() => {
                ...
                document.getElementById('play-memory-btn').style.display = 'none';
                currentRound = 0;
                score = 0;
                startGame();
            });
    ...
    function startGame() {
        gameContentDiv = document.getElementById('memory-content');
    ...
    function showResults() {
        ...
        document.getElementById('play-again-btn').addEventListener('click', () => {
            ...
            document.getElementById('play-memory-btn').style.display = 'block';
            gameContentDiv.innerHTML = '';
            playerEmail = "";
            playerName = "";
        });
